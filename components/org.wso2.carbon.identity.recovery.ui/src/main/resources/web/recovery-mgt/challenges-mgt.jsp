...
<%
    ...
    String selectedChallengeId = null;
    String selectedChallengeLocale = null;
...
<fmt:bundle basename="org.wso2.carbon.identity.recovery.ui.i18n.Resources">
    ...
    <script type="text/javascript">
        ...
        //                CARBON.showErrorDialog('Please enter a valid question id', null, null);
        //            } else if (questionLocale == null || questionLocale == "") {
        //                CARBON.showErrorDialog('Please select a locale for the question', null, null);
        //            }
        //            // validate questionId and questionLocale
        //            else {
        //                location.href = 'challenges-mgt.jsp?addRowId=' + encodeURIComponent(question) +
                            ...
                            <table cellspacing="0" id="mainTable" style="width:100%;border:none !important">
                                ...
                                <tr>
                                    ...
                                    <td id="questionTD<%=i%>" width="60%"
                                        contenteditable="true"><%=Encode.forHtmlContent(question.getQuestion())%>
                                    </td>
                                    <%
                                    } else {
                                    %>
